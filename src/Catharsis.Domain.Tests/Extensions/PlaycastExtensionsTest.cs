...
namespace Catharsis.Domain
{
  public sealed class PlaycastExtensionsTest
  {
    ...
    public void name_enumerable()
    {
      ...
      Assert.Equal(1, new[] { null, new Playcast(), new Playcast { Name = "First" }, new Playcast { Name = "Second" } }.Name("f").Count());
    }
    ...
    public void tag_enumerable()
    {
      ...
      Assert.Equal(1, new[] { null, new Playcast(), new Playcast { Tags = new HashSet<Tag> { new Tag { Name = "first" } } }, new Playcast { Tags = new HashSet<Tag> { new Tag { Name = "second" } } } }.Tag(new Tag { Name = "first" }).Count());
    }
  }
}