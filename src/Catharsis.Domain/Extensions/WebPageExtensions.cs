...
public static class WebPageExtensions
{
  ...
  public static IEnumerable<WebPage> Locale(this IEnumerable<WebPage> webPages, string locale) => webPages.Where(page => page?.Locale is not null && page.Locale.ToLower() == locale.ToLower());
  ...
  public static IEnumerable<WebPage> Name(this IEnumerable<WebPage> webPages, string name) => webPages.Where(page => page?.Name is not null && page.Name.ToLower().StartsWith(name.ToLower()));
}