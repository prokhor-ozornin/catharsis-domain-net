...
public static class SeoWebPageExtensions
{
  ...
  public static IEnumerable<SeoWebPage> Locale(this IEnumerable<SeoWebPage> webPages, string locale) => webPages.Where(page => page?.Locale is not null && page.Locale.ToLower() == locale.ToLower());
}