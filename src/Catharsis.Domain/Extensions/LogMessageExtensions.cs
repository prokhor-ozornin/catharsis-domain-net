...
public static class LogMessageExtensions
{
  ...
  public static IEnumerable<LogMessage> Level(this IEnumerable<LogMessage> messages, string level) => messages.Where(message => message?.Level is not null && message.Level.ToLower() == level.ToLower());
  ...
  public static IEnumerable<LogMessage> Logger(this IEnumerable<LogMessage> messages, string logger) => messages.Where(message => message?.Logger is not null && message.Logger.ToLower().StartsWith(logger.ToLower()));
  ...
  public static IEnumerable<LogMessage> Thread(this IEnumerable<LogMessage> messages, string thread) => messages.Where(message => message?.Thread is not null && message.Thread.ToLower() == thread.ToLower());
}