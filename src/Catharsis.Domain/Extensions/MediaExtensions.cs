...
public static class MediaExtensions
{
  ...
  public static IEnumerable<T?> Duration<T>(this IEnumerable<T?> entities, long? from = null, long? to = null) where T : Media
  {
    if (from != null)
    {
      entities = entities.Where(media => media != null && media.Duration >= from.Value);
    }

    if (to != null)
    {
      entities = entities.Where(media => media != null && media.Duration <= to.Value);
    }

    return entities.Where(media => media != null);
  }
  ...
  public static IEnumerable<T?> Height<T>(this IEnumerable<T?> entities, short? from = null, short? to = null) where T : Media
  {
    if (from != null)
    {
      entities = entities.Where(media => media != null && media.Height >= from.Value);
    }

    if (to != null)
    {
      entities = entities.Where(media => media != null && media.Height <= to.Value);
    }
  ...
  public static IEnumerable<T?> Width<T>(this IEnumerable<T?> entities, short? from = null, short? to = null) where T : Media
  {
    if (from != null)
    {
      entities = entities.Where(media => media != null && media.Width >= from.Value);
    }

    if (to != null)
    {
      entities = entities.Where(media => media != null && media.Width <= to.Value);
    }
