...
public static class WebBrowserExtensions
{
  ...
  public static IEnumerable<WebBrowser> Name(this IEnumerable<WebBrowser> browsers, string name) => browsers.Where(browser => browser?.Name is not null && browser.Name.ToLower().StartsWith(name.ToLower()));
  ...
  public static WebBrowser ValueOf(this IEnumerable<WebBrowser> browsers, string userAgent) => browsers.SingleOrDefault(browser => browser?.UserAgent is not null && browser.UserAgent.ToLower() == userAgent.ToLower());
}