...
public static class CountryExtensions
{
  ...
  public static IEnumerable<Country> Name(this IEnumerable<Country> countries, string name) => countries.Where(country => country?.Name is not null && country.Name.ToLower().StartsWith(name.ToLower()));
  ...
  public static Country ValueOf(this IEnumerable<Country> countries, string isoCode) => countries.SingleOrDefault(country => country?.IsoCode is not null && country.IsoCode.ToLower() == isoCode.ToLower());
}