...
public static class StorageFileExtensions
{
  ...
  public static IEnumerable<StorageFile> ContentType(this IEnumerable<StorageFile> files, string contentType) => files.Where(file => file?.ContentType is not null && file.ContentType.ToLower() == contentType.ToLower());
  ...
  public static IEnumerable<StorageFile> Storage(this IEnumerable<StorageFile> files, string storage) => files.Where(file => file?.Storage is not null && file.Storage.ToLower() == storage.ToLower());
}